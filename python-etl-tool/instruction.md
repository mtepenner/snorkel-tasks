...
need 3 specific routes: POST /trigger to run the etl, GET /logs to read /app/workspace/data/etl.log (which needs timestamped logs appended), and GET /download to grab the json file.
